...
{{% blocks/feature icon="fa-chess" title="Players and Arbiters" url="/chesspairing/docs/getting-started/for-arbiters/" %}}
How pairings work, what the tiebreakers measure, and how to read the output.
{{% /blocks/feature %}}

{{% blocks/feature icon="fa-terminal" title="CLI" url="/chesspairing/docs/getting-started/cli-quickstart/" %}}
Install the tool, feed it a TRF file, get pairings back. Works as a drop-in for bbpPairings and JaVaFo.
{{% /blocks/feature %}}

{{% blocks/feature icon="fa-code" title="Go API" url="/chesspairing/docs/getting-started/go-quickstart/" %}}
