...
// systems (Dutch C.04.3, Burstein C.04.4.2, Dubov C.04.4.1, and Lim C.04.4.3),
// Keizer pairing, and round-robin pairing, along with standard, Keizer, and
// football scoring systems and 25 tiebreaker algorithms.
//
